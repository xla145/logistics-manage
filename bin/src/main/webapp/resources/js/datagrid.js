...
//				floatBox.css('min-width',$tableWidth+1000)
				if($fixedLefts.length > 0){
					tableLeft.append(leftBox.append($table.clone(true).width($table.outerWidth(true)+1000)));
		 		...
		 		if($fixedRights.length > 0){
			  		...
			  		tableRight.append(rightBox.append(rightTable.width($table.outerWidth(true)+1000)));
