package com.logistics.service.imageText.impl;
...
import com.logistics.base.constant.ImageTextConstant;
...
public class ImageTextGroupServiceImpl implements IImageTextGroupService{
    ...
    public RecordBean<String> startOrStopGroup(Integer id, Integer status) {
        status = status == ImageTextConstant.IMAGE_TEXT_GROUP_DISABLE_STATUS? ImageTextConstant.IMAGE_TEXT_GROUP_ENABLE_STATUS:ImageTextConstant.IMAGE_TEXT_GROUP_DISABLE_STATUS;
    ...
    public RecordBean<String> checkCode(String code,Integer groupId) {
        ...
        if (textGroup == null || textGroup.getId() == groupId) {
            return RecordBean.success("success!");
        }
