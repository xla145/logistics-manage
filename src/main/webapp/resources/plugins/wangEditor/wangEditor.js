...
var config = {
    ...
    // 默认菜单配置
    menus: ['head', 'bold', 'italic', 'underline', 'strikeThrough', 'foreColor','fontSize', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'code', 'undo', 'redo'],
...
Panel.prototype = {
    ...
    show: function show() {
        ...
        var width = opt.width || 400; // 默认 400px
...
// 构造函数
    function FontSize(editor) {
        ...
        this.droplist = new DropList(this, {
            ...
            $title: $('<p>文字大小</p>'),
            type: 'inline-block', // droplist 内容以 block 形式展示
            list: [{ $elem: $('<i style="font-size:10px;">5</i>'), value: '1' }, { $elem: $('<i style="font-size:14px;">15</i>'), value: '3.5' }, { $elem: $('<i style="font-size:16px;">20</i>'), value: '4' }, { $elem: $('<i style="font-size:18px;">25</i>'), value: '6' }, { $elem: $('<i style="font-size:20px;">30</i>'), value: '7' }],
            onClick: function onClick(value) {
                // 注意 this 是指向当前的 BackColor 对象
                console.log(value+"+++++++++++++++++++++++")
                _this._command(value);
...
function Video(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu"><i class="w-e-icon-activtiy"><i/></div>');
    this.type = 'panel';
